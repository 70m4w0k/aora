...
export const appwriteConfig = {
  ...
  // Calendar Events
  eventsCollectionId: "events", // TODO: Create in Appwrite
  // Habits Tracker (NEOSYSTEM)
  habitsArcsCollectionId: "habits_arcs", // TODO: Create in Appwrite
  habitsQuestsCollectionId: "habits_quests", // TODO: Create in Appwrite
  habitsQuestsCompletionsCollectionId: "habits_quests_completions", // TODO: Create in Appwrite
  habitsTiersCollectionId: "habits_tiers", // TODO: Create in Appwrite
  habitsTiersCompletionsCollectionId: "habits_tiers_completions", // TODO: Create in Appwrite
  habitsUserProgressCollectionId: "habits_user_progress", // TODO: Create in Appwrite
};
...
export async function completeQuest(form) {
  try {
    ...
    const streakCount = form.streakCount || 1;
    ...
    await updateUserProgress(form.userId, form.householdId, form.xpEarned || 10, form.arcId, 'quest');
...
export async function completeTier(form) {
  try {
    ...
    // Update user progress
    await updateUserProgress(form.userId, form.householdId, form.xpEarned || 100, form.arcId, 'tier');
...
// Update User Progress
export async function updateUserProgress(userId, householdId, xpEarned, arcId = null, completionType = null) {
  try {
    ...
    if (arcId) {
      ...
      arcProgressData[arcId].totalXP = (arcProgressData[arcId].totalXP || 0) + xpEarned;
