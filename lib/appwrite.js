...
export async function completeQuest(form) {
  try {
    ...
    await updateUserProgress(form.userId, form.householdId, form.xpEarned || 10, form.arcId);
...
export async function completeTier(form) {
  try {
    ...
    // Update user progress
    await updateUserProgress(form.userId, form.householdId, form.xpEarned || 100, form.arcId);
...
// Update User Progress
export async function updateUserProgress(userId, householdId, xpEarned, arcId = null) {
  try {
